 ...
 * License.....: MIT
 * modified by cyclone https://github.com/cyclone-github/hashcat_26620_kernel
 */
...
static const u64   KERN_TYPE      = 26620;
...
int module_hash_decode (MAYBE_UNUSED const hashconfig_t *hashconfig, MAYBE_UNUSED void *digest_buf, MAYBE_UNUSED salt_t *salt, MAYBE_UNUSED void *esalt_buf, MAYBE_UNUSED void *hook_salt_buf, MAYBE_UNUSED hashinfo_t *hash_info, const char *line_buf, MAYBE_UNUSED const int line_len)
{
  ...
  token.token_cnt  = 5; // Including dynamic iteration count token
  ...
  token.sep[1]     = '$';
  token.len_min[1] = 1; // Minimum length of iterations
  token.len_max[1] = 10; // Maximum length of iterations
